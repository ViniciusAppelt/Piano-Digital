...
const keyDownMapper = {
    ...
    "Delete": () => handleMouseDown(keys[19]),
    "Home": () => handleMouseDown(keys[20]),
    "End": () => handleMouseDown(keys[21]),
    "PageUp": () => handleMouseDown(keys[22]),
    "PageDown": () => handleMouseDown(keys[23])
}
...
const keyUpMapper = {
    ...
    "Delete": () => handleMouseUp(keys[19]),
    "Home": () => handleMouseUp(keys[20]),
    "End": () => handleMouseUp(keys[21]),
    "PageUp": () => handleMouseUp(keys[22]),
    "PageDown": () => handleMouseUp(keys[23])
}
